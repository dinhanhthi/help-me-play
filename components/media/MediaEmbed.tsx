...
function MediaSkeleton() {
  return (
    <div className="flex h-[210px] shrink-0 w-full items-center justify-center rounded-xl bg-surface">
...
function MediaContent({
  ...
  if (
    ...
    return (
      <div className="flex flex-col gap-0.5 items-center justify-center h-full">
        <div
          className="relative max-h-[210px] overflow-hidden rounded-xl w-full"
  ...
  if (media.type === "video") {
    return (
      <div className="flex flex-col gap-0.5 items-center justify-center h-full">
        <div className="relative max-h-[210px] overflow-hidden rounded-xl w-full">
          {!loaded && <MediaSkeleton />}
          <video
            ref={videoRef}
            src={media.embedUrl}
            controls
            className={`w-full max-h-[210px] object-contain transition-opacity duration-300 ${loaded ? "opacity-100" : "absolute inset-0 opacity-0"}`}
            title={accessibleTitle}
